...
{  
  ...
  [[PhotoManager shareInstance] GetInfo];
  ...
  self.photoPickerviewController = [[[PhotoPickerViewController alloc] init] autorelease];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"TalkingPhoto" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"TalkingPhoto.sqlite"];
